...
export const cloth_icon = require("../assets/icons/down_arrow_icon.png");
export const down_arrow = require("../assets/icons/baby_car_icon.png");
...
export const pin = require("../assets/icons/pin_icon.png");
export const sports_icon = require("../assets/icons/sports_icon.png");
export const up_arrow = require("../assets/icons/up_arrow_icon.png");
